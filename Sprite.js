...
//Adding image to all our spties.
...
full_image = loadImage("Images/Full.gif");

one_down_image = loadImage("Images/1 down.gif");

two_down_image = loadImage("Images/2 down.gif");

three_down_image = loadImage("Images/3 down.gif");

over_image = loadImage("Images/over.gif")

treasure_image = loadImage("Images/Treasure.png");

spike_ball_image = loadImage("Images/Spike ball.png");

laser_image = loadImage("Images/laser.png");

laser2_image = loadImage("Images/laser2.png");

gameover_image = loadImage("Images/Gameover.gif");
